...
import '../../../data/models/is_item_model.dart';
import '../../../data/utils/app_space.dart';
import '../controllers/bazar_items_controller.dart';

class BazarItemsView extends GetView<BazarItemsController> {
  const BazarItemsView({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    List<ItemModel> data = Get.arguments;
                ...
                child: Column(children: <Widget>[
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return ListTile(
                          ...
                          subtitle: Text(data[index].itemPrice.toString() +
                              " x " +
                  ...
                  SizedBox(
                      ...
                      child: ElevatedButton(
                        child: const Text("Share & PDF File"),
                        onPressed: () {
                          print('Printer');
                          Get.to(Printer());
                        },
